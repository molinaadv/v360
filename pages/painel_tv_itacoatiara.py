# -*- coding: utf-8 -*-
"""
PAINEL TV · PERÍCIAS & AUDIÊNCIAS — Núcleo Itacoatiara (V360 Molina)
================================================================
Unidades: ITACOATIARA, AÇÃO ITACOATIARA, URUCURITUBA, SILVES, ITAPIRANGA, PARINTINS.
...
mais robusto. Ex.: "Perícia ADM (ITACOATIARA)".

Colocar este arquivo em /pages, ao lado de painel_template_itacoatiara.html.
...
MINUTOS_SYNC = 5
ALTURA_TV    = 1040
NUCLEO_LABEL = "Itacoatiara"      # nome do núcleo exibido nas telas
...
UNI_CURTO = {
    ...
    "PARINTINS":   "PARINTINS",
    "AÇÃO ITACOATIARA": "AÇÃO ITACOATIARA",
}
...
# ---------------------------------------------------------------------
UNIDADES_PEND = ["ITACOATIARA", "AÇÃO ITACOATIARA"]   # <<< CONFERIR nomes exatos
UNIDADES_META = ["ITACOATIARA"]                        # <<< meta só Itacoatiara
...
# PÁGINA
# ======================================================================
st.set_page_config(page_title="Painel TV Itacoatiara", layout="wide",
                   initial_sidebar_state="collapsed")
st_autorefresh(interval=MINUTOS_SYNC * 60 * 1000, key="tv_itacoatiara_sync")
st.markdown("""
<style>
...
def _classifica(subtipo):
    """(unidade, categoria) a partir do nome do subtipo. Ex.:
       'Perícia ADM (ITACOATIARA)' -> ('PORTO VELHO - UNID 2', 'pericia')."""
...
template = Path(__file__).with_name("painel_template_itacoatiara.html").read_text(encoding="utf-8")
