# -*- coding: utf-8 -*-
"""
PAINEL TV · PERÍCIAS & AUDIÊNCIAS — Núcleo Iranduba (V360 Molina)
================================================================
Unidades: IRANDUBA, AÇÃO IRANDUBA.
...
mais robusto. Ex.: "Perícia ADM (IRANDUBA)".

Colocar este arquivo em /pages, ao lado de painel_template_iranduba.html.
...
MINUTOS_SYNC = 5
ALTURA_TV    = 1040
NUCLEO_LABEL = "Iranduba"      # nome do núcleo exibido nas telas
...
# ---------------------------------------------------------------------
UNIDADES_PEND = ["IRANDUBA", "AÇÃO IRANDUBA"]   # <<< CONFERIR nomes exatos
UNIDADES_META = ["IRANDUBA"]                        # <<< meta só Itacoatiara
...
# PÁGINA
# ======================================================================
st.set_page_config(page_title="Painel Iranduba", layout="wide",
                   initial_sidebar_state="collapsed")
st_autorefresh(interval=MINUTOS_SYNC * 60 * 1000, key="tv_iranduba_sync")
st.markdown("""
<style>
...
def _classifica(subtipo):
    """(unidade, categoria) a partir do nome do subtipo. Ex.:
       'Perícia ADM (IRANDUBA)' -> ('IRANDUBA', 'pericia')."""
...
template = Path(__file__).with_name("painel_template_iranduba.html").read_text(encoding="utf-8")
