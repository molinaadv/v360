...
Colocar este arquivo em /pages, ao lado de painel_template_manacapuru.html.
...
MINUTOS_SYNC = 5
ALTURA_TV    = 1040
NUCLEO_LABEL = "Manacapuru"      # nome do núcleo exibido nas telas
...
UNI_CURTO = {
    ...
    "AÇÃO MANACAPURU": "AÇÃO MANACAPURU",
}
...
# ---------------------------------------------------------------------
UNIDADES_PEND = ["MANACAPURU", "AÇÃO MANACAPURU"]   # <<< CONFERIR nomes exatos
UNIDADES_META = ["MANACAPURU"]                        # <<< meta só Manacapuru
...
# PÁGINA
# ======================================================================
st.set_page_config(page_title="Painel Manacapuru", layout="wide",
                   initial_sidebar_state="collapsed")
st_autorefresh(interval=MINUTOS_SYNC * 60 * 1000, key="tv_manacapuru_sync")
st.markdown("""
<style>
...
template = Path(__file__).with_name("painel_template_manacapuru.html").read_text(encoding="utf-8")
